...
async function loadProjectDetails() {
  try {
    ...
    if (allProjects.length === 0) {
        ...
        document.getElementById('project-summary').textContent = "تم تحميل mockData.js ولكن مصفوفة المشاريع (window.PROJECTS) فارغة. يرجى مراجعة محتوى الملف والتأكد من ترتيب ملفات JavaScript في صفحة HTML.";
