<div class="max-w-7xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-[var(--text-main)]">إنشاء مشروع جديد</h1>
            <p class="text-[var(--text-muted)]">إضافة مشروع جديد للمنصة</p>
        </div>
    </div>

    <div class="card p-6">
        <form id="project-form" method="POST" action="<?= route('manager.projects.store') ?>" enctype="multipart/form-data" class="space-y-6">
            <div>
            ...
            <div>
                ...
                <p class="text-xs text-[var(--text-muted)] mb-3">انقر على الخريطة لتحديد موقع المشروع</p>
                ...
                <div id="selected-location" class="mt-3 p-3 bg-[var(--bg-body)] rounded-lg border border-[var(--border-light)] hidden">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-3 pt-6 border-t border-[var(--border-light)]">
                ...
                <div class="flex gap-3 items-center">
                    ...
                    >
                        <i class="fas fa-plus ml-2"></i> إنشاء المشروع
                    </button>
                </div>
            </div>
            ...
            <div class="flex-1 overflow-hidden flex flex-col">
                ...
                <div class="p-4 border-t border-[var(--border-light)] flex justify-end gap-2">
                    ...
                    <button type="button" id="apply-bank-selection" class="btn btn-primary">
                        <i class="fas fa-check ml-2"></i> إضافة الأسئلة المحددة
                    </button>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Keep selection in sync whenever a checkbox changes
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    map.on('click', function(e) {
        ...
        // Reverse geocoding (optional - get place name)
